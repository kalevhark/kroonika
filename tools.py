...
Eduard Allas,
Arnold Ersto,
Iisak(Itsik) Friedmann,
Paavel Jauk,
Vladimir Karro,
August Koolmeister,
Nikolai Kuks,
Karl Laar,
Helmut-Chariton Mitt,
Oskar Mägraken,
Evald-Eduard-Ferdinand Pettai,
Artur Raamat,
Gustav-Ludvig Reiman,
Aleksei Riit,
Maksim-Juulius Roosman,
Eduard-Oskar Saar,
Richard-Julius Saar,
Arnold Schütz,
Arnold Tamm,
Leopold-Arkadius Toom,
Anatol Ustav,
Endel-Lembit Varik
    """
    # Millise artikliga siduda isik
    ...
    print(viited)
    # Isiku kirjeldus
    isik_kirjeldus = 'Valga poeglaste gümnaasiumi reaalharu lõpetaja 1931'
    isikud = isik_str.split(',')
    for isik in isikud:
        # Loome uue isiku
        isik_nimi = isik.strip().split(' ')
