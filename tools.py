...
Karl Aid,
Hans Hendriks,
Johann-Alfred Jaanusson,
Elieeser Kalmanson,
Arnold Kasak,
Ilmar Keller,
Friedrich Koolmeister,
Valentin Kučinski,
Ferdinand Kõivumägi,
Johann-Voldemar Kärse,
Alfred Orav,
Eduard Paap,
Heino Peep,
Arnold Tamm,
Ortvin-Romold Tennof,
Arnold-Julius Tiits,
Heinrich-Raimund Unt,
Arkadi Visnapuu
    """
    # Millise artikliga siduda isik
    ...
    print(viited)
    # Isiku kirjeldus
    isik_kirjeldus = 'Poeglaste gümnaasiumi humanitaarharu lõpetaja 1928'
    isikud = isik_str.split(',')
    for isik in isikud:
        # Loome uue isiku
        isik_nimi = isik.strip().split(' ')
