...
def massikanne_from_data():
    ...
    isik_str = """
Helga Ahmann,
Salme Vilhelmine Eller,
Elisabeth Elstin,
Olga Havist,
Alice Järv,
Salme Eludi Kalkun,
Alvine Vilhelmine Kasak,
Alma Helene Kruschka,
Veera Kübar,
Valve Lammas,
Hilda Põder,
Elfriede Ruder,
Aino Elfriede Velner,
Ludmilla Vernik,
Elviine Emilie Villermann,
    """
    # Millise artikliga siduda isik
    ...
    print(viited)
    # Isiku kirjeldus
    isik_kirjeldus = 'Tütarlaste gümnaasiumi majapidamise haru lõpetaja 1928'
    isikud = isik_str.split(',')
    for isik in isikud:
        # Loome uue isiku
        isik_nimi = isik.strip().split(' ')
