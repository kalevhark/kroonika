...
def massikanne_from_data():
    ...
    isik_str = """
    Hilda Gross,
    Elise Helene Illison,
    Alvine Johanna Jaanson,
    Ellinor Alise Kaigas,
    Elena Karavits,
    Lilli Emilie Kyma,
    Salme Marie Kyma,
    Herta Johanna Linde,
    Leida Ludmilla Luts,
    Eudokia Hedvig Lääts,
    Salme Madisson,
    Emilie Metusala,
    Linda Alide Mõttus,
    Adele Padjas,
    Veera Ruubel,
    Ingeborg Anna Sallum,
    Valentina Sviksch,
    Magdalene Vassar,
    Eugenie Vellner,
    Hilda Alide Villist
    ...
    print(viited)
    # Isiku kirjeldus
    isik_kirjeldus = 'Tütarlaste gümnaasiumi humanitaarharu lõpetaja 1926'
    isikud = isik_str.split(',')
    for isik in isikud:
        # Loome uue isiku
        isik_nimi = isik.strip().split(' ')
