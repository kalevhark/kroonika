var watchExampleVM = new Vue({
    ...
    methods: {
      getAnswer: function () {
        ...
        var isik_api_url = '/kroonika/api/isik/?format=json';
        var organisatsioon_api_url = '/kroonika/api/organisatsioon/?format=json';
        var objekt_api_url = '/kroonika/api/objekt/?format=json';
        var artikkel_api_url = '/kroonika/api/artikkel/?format=json';
        var vm = this;
