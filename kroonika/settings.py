...
DEFAULT_MAP_AASTA = '2026' # objektide vaates kaardi vaikimise kiht
...
GEOJSON_STYLE = {
    ...
    'A': {'fill': None, 'color': FUCHSIA, 'weight': 3, 'dashArray': '2, 5'}, # ala (default)
    ...
    'AE': {'fill': None, 'color': OBJEKT_COLOR, 'weight': 3, 'dashArray': '2, 5'}, # ala (olemas kaasajal)
