...
class APITestWikiListingCase(TestCase):
    ...
    def test_allrouters_listing_api(self):
        ...
        self.assertEqual(self.list_api_routers.status_code, 200)
    ...
    def test_artikkel_listing_api(self):
        ...
        self.assertEqual(self.list_api_result.json()["count"], count)
    ...
    def test_artikkel_detail_api(self):
        ...
        self.assertEqual(self.list_api_result.json()["slug"], slug)
        self.assertEqual(self.list_api_result.status_code, 200)
