...
urlpatterns = [
    ...
    path('kroonika/<int:year>/<int:month>/', (cache_page(60 * 15)(ArtikkelMonthArchiveView.as_view(month_format='%m'))), name='artikkel_month_archive'),
    path('kroonika/<int:year>/<int:month>/otheryears/', (cache_page(60 * 15)(views.artikkel_month_archive_otheryears)), name='artikkel_month_archive_otheryears'),
